[[cap-09-La-fine-dei-primi-vent-anni]]
...
mostra …”) è menzionata dal Buddha (<<cap-09-La-fine-dei-primi-vent-anni.adoc#pag162,qui>> e anche <<cap-09-La-fine-dei-primi-vent-anni.adoc#pag167,qui>>).
