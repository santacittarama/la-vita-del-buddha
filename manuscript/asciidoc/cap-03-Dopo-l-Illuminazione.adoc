...
questi significati sono le Divine Dimore (_brahmāvihara_: <<10-Il-periodo-di-mezzo.adoc#pag200,cap. 10 -- _Questo dovrebbe essere fatto_>>)
...
(_brahmayāna_: <<12-La-Dottrina.adoc#pag281,cap. 12 -- _Un mattino il venerabile Ānanda..._>>), e così via.] che pratica la meditazione +
...
il <<04-La-diffusione-del-Dhamma.adoc#pag70,cap. 4 -- _Allora le tre figlie di Māra..._>>).
Un altro episodio, qui non incluso, di alcuni
brāhmaṇa che rimproverano il Buddha per non aver prestato loro omaggio
(<<09-La-fine-dei-primi-vent-anni.adoc#pag137,cf. cap. 9 -- _Avvenne questo. Il Buddha..._>>), è correlato ad A. 4:22.] dopo essere emerso da
...
fuoco (S. 35:28, cit. nel <<04-La-diffusione-del-Dhamma.adoc#pag73,cap. 4 -- _Il Sermone del Fuoco_>>) della bramosia, dell’odio e
dell’illusione, e delle loro conseguenze. Non deve essere intesa per
significare l’“estinzione di una persona vivente” (si veda il <<11-La-persona.adoc#pag226,cap. 11 -- _Colui che è Così-Andato..._>>).
...
del sé (<<12-La-Dottrina.adoc#pag254,si veda il cap. 12 -- _Le sei basi, di per se stesse..._>>).] +
