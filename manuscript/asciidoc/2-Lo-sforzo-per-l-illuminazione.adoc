...
cercare ciò che è buono link:#nota1[^1^], per cercare il supremo stato
della pace sublime. Per questo andai da Āḷāra Kālāma e gli dissi: “Amico
...
salutari link:#nota2[^2^]. Io però non dimoro in una remota boscaglia
...
come una pietra un vaso d’argilla cruda» link:#nota3[^3^].
...
nel primo jhāna link:#NDT1[^NDT1^], che è accompagnato dal pensiero e
dall’esplorazione uniti alla felicità e al piacere nati
dall’isolamento link:#NDT2[^NDT2^]. Pensai: “Che sia questa la via per
l’Illuminazione?”».
...
bollito e del pane?”» link:#nota4[^4^].
...
per acqua e per aria link:#nota5[^5^].
...
interdipendente link:#nota6[^6^]. In seguito dovremo tornare su questo
argomento.
...
un’appropriata attenzione link:#nota7[^7^] riuscii a capire: “La
...
[[nota1]]1. Kusala: salutare, vantaggioso

//link:#OrigineNota1[image:../Images/BackArrow.jpg[<--]]

[[nota2]]2. Akusala: originariamente qui tradotto con “infruttuose”
(Nyp.)

//link:#OrigineNota2[image:../Images/BackArrow.jpg[<--]]

[[nota3]]3. Ciò a cui gli ultimi versi (qui omessi ma inclusi nel cap.
4, p. 70) di questo canto fanno riferimento è collocato dai _Commentari_
un anno più tardi rispetto al
resto.

//link:#OrigineNota3[image:../Images/BackArrow.jpg[<--]]

[[NDT1]]NDT1. Assorbimento mentale (jhāna), uno stato di forte
...
(_Parinibbāna_) del Buddha (cfr. p.
364).

//link:#OrigineNDT1[image:../Images/BackArrow.jpg[<--]]

[[NDT2]]NDT2. Qui come in seguito, allorché questo passo si ripete, i
...
scelte di bhikkhu Ñāṇamoli.

//link:#OrigineNDT2[image:../Images/BackArrow.jpg[<--]]

[[nota4]]4. Il dizionario della Pāli Text Society ha “junket” (giuncata)
per _kummāsa_, che i _Commentari_ dicono essere tuttavia fatta di farina
(_yava_).

//link:#OrigineNota4[image:../Images/BackArrow.jpg[<--]]

[[nota5]]5. I diversi modi nei quali i discorsi descrivono
...
dell’abbandono dei cattivi pensieri (M. 19),
ecc.

//link:#OrigineNota5[image:../Images/BackArrow.jpg[<--]]

[[nota6]]6. Per la genesi interdipendente (originazione interdipendente
o coproduzione condizionata), si veda il capitolo
12.

//link:#OrigineNota6[image:../Images/BackArrow.jpg[<--]]

[[nota7]]7. Oppure: approfondita considerazione, saggia riflessione
(_yoniso manasikāra_)
(Nyp.).
