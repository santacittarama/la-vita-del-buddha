...
di Sakka, Sovrano degli Déi. Il Beato chiese al venerabile Nanda:
...
[[nota1]]1. Il _Mālālankāravatthu_ dice che questa stagione delle piogge
fu trascorsa a Rājagaha, nel Boschetto di Bambù, ma ciò è errato.
link:#OrigineNota1[image:../Images/BackArrow.jpg[<--]]

[[nota2]]2. Almeno due dei discorsi più esoterici del _Sutta Piṭaka_ (M.
