...
dottrina dietro invito di una Divinità (<<cap-03-Dopo-l-Illuminazione.adoc#pag45,cap. 3 -- _Allora Brahmā Sahampati..._>>), e che egli
...
<<cap-13-Devadatta.adoc#pag298,cap. 13 -- _Ho permesso (di mangiare) pesce o carne..._>>). Probabilmente non riusciremo mai a sapere l’esatto
...
[[pag364]]Queste furono le ultime parole del Beato.
