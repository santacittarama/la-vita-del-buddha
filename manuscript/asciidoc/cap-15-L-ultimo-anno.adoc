...
dottrina dietro invito di una Divinità (<<03-Dopo-l-Illuminazione.adoc#pag45,cap. 3 -- _Allora Brahmā Sahampati..._>>), e che egli
...
<<13-Devadatta.adoc#pag298,cap. 13 -- _Ho permesso [di mangiare] pesce o carne..._>>). Probabilmente non riusciremo mai a sapere l’esatto
