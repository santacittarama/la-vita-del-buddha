...
La bhikkhuṇī Thullānandā link:#nota1[^1^] udì queste parole. Ella pensò:
...
con il suo Commentario a Ceylon link:#nota2[^2^], mentre altri anziani
...
[[nota1]]1. La bhikkhunī Thullānandā compare spesso nel Vinaya come una
donna orgogliosa, intelligente e faziosa, che causò la stesura di
numerose regole. link:#OrigineNota1[image:../Images/BackArrow.jpg[<--]]

[[nota2]]2. L’attuale Sri Lanka (BB).
