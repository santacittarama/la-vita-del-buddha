...
«Questo era il mio ascetismo link:#nota1[^1^]. Andavo nudo, rifiutavo le
...
Dimore link:#nota2[^2^], perché se io fossi nato nelle Pure Dimore non
sarei mai dovuto tornare in questo mondo».
...
[[nota1]]1. Le austerità qui descritte sono principalmente quelle
raccomandate dalla religione jainista.
link:#OrigineNota1[image:../Images/BackArrow.jpg[<--]]

[[nota2]]2. Le “Pure Dimore” sono parte dell’alto mondo di Brahmā
...
raggiungono il Nibbāna
definitivo. link:#OrigineNota2[image:../Images/BackArrow.jpg[<--]]
