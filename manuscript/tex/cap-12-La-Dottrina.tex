...
\voice{Prima voce.} (FIXME label pag230)Una volta, quando il Beato era entrato a Rājagaha per la
...
\narrator{Secondo narratore.} La coscienza è concepibile senza un passato? Si può
...
\narrator{Secondo narratore.} È stato detto che la Verità della Sofferenza era «in
...
\narrator{Secondo narratore.} La retta visione ha molte sfaccettature. Osserviamole
...
\voice{Prima voce.} «Viene prima la retta visione.\footnote{Fino ad ora sono stati offerti solo dettagli analitici delle prime tre Nobili Verità. Qui incontreremo mere descrizioni che ci aiutano a comprenderle.} Come? Si
...
\narrator{Secondo narratore.} La stessa essenza della retta visione è, tuttavia, la
...
\narrator{Secondo narratore.} È di nuovo la retta visione delle tre caratteristiche
...
\voice{Prima voce.} (FIXME label pag259)«Com’è che perviene a esistere l’opinione della
...
\narrator{Secondo narratore.} L’uomo ignorante e ordinario è ignaro della sottile
...
\narrator{Secondo narratore.} Questi due fattori della retta visione e della retta
...
\narrator{Secondo narratore.} Gli ultimi tre fattori, retta parola, retta azione e
...
\narrator{Secondo narratore.} Nessuno di questi otto conseguimenti (né le quattro
...
\narrator{Secondo narratore.} Con questo si conclude tale esposizione. Ma come è in
...
\voice{Prima voce.} (FIXME label pag281)Un mattino il venerabile Ānanda si vestì, prese la ciotola e
