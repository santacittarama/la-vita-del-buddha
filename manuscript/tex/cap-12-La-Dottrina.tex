...
\voice{Prima voce.} \label{pag230}Una volta, quando il Beato era entrato a Rājagaha per la
...
\voice{Prima voce.} \label{pag259}«Com’è che perviene a esistere l’opinione della
...
\voice{Prima voce.} \label{pag281}Un mattino il venerabile Ānanda si vestì, prese la ciotola e
